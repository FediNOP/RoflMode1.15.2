...
public class TestChunkGenerator extends NoiseChunkGenerator<TestGenSettings> {
    ...
    public TestChunkGenerator(IWorld worldIn, BiomeProvider provider, TestGenSettings settingsIn) {
